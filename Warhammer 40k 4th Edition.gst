...
<gameSystem id="96e2-b781-50d7-3d18" name="Warhammer 40k 4th Edition" revision="3" battleScribeVersion="2.03" authorName="NRAnon" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" type="gameSystem">
  ...
  <categoryEntries>
    ...
    <categoryEntry id="6953-6bba-0bb9-d49d" name="Infantry" hidden="false">
      <description>Includes all foot soldiers, human or alien. A typical Unit of Infantry is between 5-10 models</description>
    </categoryEntry>
    ...
    <categoryEntry id="75ea-544f-fd8b-51d2" name="Infantry" hidden="false">
      <description>Includes all foot soldiers, human or alien. A typical Unit of Infantry is between 5-10 models


Movement range is 6”, all Core rules apply.



Charge range is 6”, all Core rules apply.



Fall Back moves are 2D6”, all Core rules apply.</description>
    </categoryEntry>
    <categoryEntry id="b3bf-01b4-c272-3409" name="Jump Infantry" hidden="false">
      <description>Includes all models equipped with jump packs, jet packs, wings, teleport devices, and other means of moving quickly over short distances. 


A typical Unit of Jump Infantry is between 5-10 models.</description>
    </categoryEntry>
    <categoryEntry id="eb69-c8af-f212-635f" name="Beasts &amp; Cavalry" hidden="false">
      <description>Includes hunting animals and riders with a mount. A typical Unit of Beasts &amp; Cavalry is between 1-6 models.


Riders may not dismount during the game, and cavalry models have a single, combined Characteristic Profile for both the mount and rider.</description>
    </categoryEntry>
    <categoryEntry id="86cf-31f2-e698-7a81" name="Bikes" hidden="false">
      <description>Includes all riders with small vehicles that count as Non-Vehicle Models. 


A typical Unit of Bikes &amp; Jetbikes is between 3-5 models. 


Riders may not dismount during the game, and Biker &amp; Jetbiker models have a combined Characteristic Profile for both the vehicle and rider.
...
purpose of adjudicating Instant Death</description>
    </categoryEntry>
    ...
    <categoryEntry id="ca5d-3c3b-217c-c72d" name="Vehicle" hidden="false">
      <description>Includes all Vehicle Models. Typically consists of a single Size 3 model. Crew members (drivers, commanders, and gunners) are assumed to be an integral part of the model, and if their Vehicle is destroyed they are lost along with it. 
------------------------------------------------------------------------------------------------------------</description>
    </categoryEntry>
    ...
    <categoryEntry name="Monstrous Creatures" id="a912-19e9-7d18-be18" hidden="false">
      <description>Includes Size 3 models that are not Vehicle Models, such as giant alien beasts or certain demonic entities. 


A typical unit of Monstrous Creatures is 1 model.
...
not Invulnerable Saves). When attacking a Vehicle in Close Combat roll 2D6+Strength for Armor Penetration unless specified otherwise.</description>
    </categoryEntry>
    <categoryEntry name="Artillery" id="c85f-462d-b3ba-2c8c" hidden="false"/>
    <categoryEntry name="Characters" id="e793-1a61-b449-104b" hidden="false">
      <description>Characters (typically HQ units) are a special class of model that comes with special rules in addition to their other type, indicated as Character: (Infantry), or Character: (Bikes). 


A Character is always a single model.</description>
    </categoryEntry>
    <categoryEntry name="Rapid Fire" id="7e74-5323-8f77-ce4b" hidden="false"/>
    <categoryEntry name="Pistol" id="4e62-7392-6654-6692" hidden="false"/>
    <categoryEntry name="Assault" id="59b5-0858-4f50-f411" hidden="false"/>
    <categoryEntry name="Heavy" id="cf51-87f3-c5e2-74ba" hidden="false"/>
    <categoryEntry name="Lance" id="94ba-96a3-27c3-31a6" hidden="false"/>
    <categoryEntry name="Ordnance" id="c049-2ca3-ec99-0203" hidden="false"/>
    <categoryEntry name="Blast" id="7b0a-5147-e722-39b7" hidden="false"/>
    <categoryEntry name="Gets Hot!" id="0ddc-d42f-9333-f725" hidden="false"/>
    <categoryEntry name="Twin-Linked" id="2dc4-21ce-e1a4-3a15" hidden="false"/>
    <categoryEntry name="Melta" id="0003-5927-1ea1-3177" hidden="false"/>
    <categoryEntry name="Template" id="788b-819b-fa1d-0307" hidden="false"/>
    <categoryEntry name="Barrage" id="e829-25f1-67c0-e670" hidden="false"/>
    <categoryEntry name="Pinning" id="280e-23f1-7823-9427" hidden="false"/>
    <categoryEntry name="Sniper" id="b630-df7f-e347-fb25" hidden="false">
      <description>Sniper weapons always make their To-Hit roll against 2+ regardless of the model’s BS, and always Wound on 4+ regardless of shooter S or target T.


Against Vehicles only, may roll 2D6+S for Armor Penetration.</description>
    </categoryEntry>
    <categoryEntry name="Rending" id="d41a-e845-6106-72c6" hidden="false">
      <description>All rolls To-Hit of 6 with this weapon results in an automatic Wound that ignores Armor Save (Sv) (but not Invulnerable Save). 
...
Against Vehicles, roll an additional D6 if a result of 6 is obtained when testing Armor Penetration, summing the result of both rolls for the purposes of the test.</description>
    ...
    <categoryEntry name="Poisoned" id="4262-67b6-eda5-b81e" hidden="false"/>
    <categoryEntry name="Jetbikes" id="9c28-640a-e980-e865" hidden="false">
      <description>Includes all riders with small vehicles that count as Non-Vehicle Models. 
...
Movement range is increased to 12”, and may move over any other models. When moving over Difficult Terrain may choose to not treat it as Dangerous Terrain, but doing so means they may not use said Terrain for a Cover Save, and are considered as tall the Area Terrain for LOS purposes. All Jetbikes have the Turbo Boosters Special Rule.


As Bikes, but Jetbikes cannot choose to move over Difficult
Terrain in the Assault Phase.</description>
    </categoryEntry>
  </categoryEntries>
  <forceEntries>
      ...
      <categoryLinks>
        <categoryLink id="d4a3-35ce-7202-922e" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="de34-49f5-ca37-bd3c">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
          </modifiers>
          <constraints>
        ...
        <categoryLink id="e22b-c7c6-f647-feb7" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="8e87-f8f1-633e-271c">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="49cd-5f5d-2ea1-0222" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="f89d-290e-70c3-64ca">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="c3f7-5895-ade5-8674" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="79b1-ccaf-d2c5-9d2b">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="bb74-4f6a-0881-dae1" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="6663-4d34-9b7a-4273">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="d21f-5bbf-4583-8a99" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="d540-a457-070f-5fb2">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="1cf2-6528-1f81-871e" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="582b-d1ef-880e-5a17">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="5186-4358-de7f-7031" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="1833-9f65-64d8-c3c7">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="ca8b-e4f5-c0d0-1490" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="c6c7-55b5-c4ed-489a">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="afa3-08e9-5b3f-b7ca" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="3269-af73-e42b-6671">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="f3f6-47b1-09df-f5ed" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="1c94-e417-3141-8ee5">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="5892-944b-5717-6b60" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="f869-0cca-ee96-c53d">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="ac99-94ae-0204-d610" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="eb67-55a4-8348-64e6">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="9b2f-c8c9-f318-31f8" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="da2a-d8dc-04c8-f4e9">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="df83-b739-e368-5360" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="f731-8ccb-6d84-fd38">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="cbb8-aedd-2f13-0783" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="e506-f3a8-2fe5-2d95">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="1915-959e-90d1-4fb4" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="ce62-bdd1-f774-7e08">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="cfe7-fb49-2f5c-e908" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="2c4b-215d-07a6-4bac">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="5802-6a53-04a1-da4b" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="730f-46ca-7528-3ce7">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="6672-273c-cb32-648b" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="e51a-6fda-2f35-f70d">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="374c-7702-f4aa-2ae1" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="6380-614a-df74-1f96">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
      ...
      <categoryLinks>
        <categoryLink id="f1f2-c92c-18bb-b3d3" name="Elites" hidden="false" targetId="6d25-b346-c314-6911" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="ee32-676f-9d7c-6efd">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="70aa-e29a-65b9-baad" name="Fast Attack" hidden="false" targetId="34e2-d53c-28ab-44cf" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="068e-8717-6e50-bb79">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
        ...
        <categoryLink id="d69b-3fc9-7777-b048" name="Heavy Support" hidden="false" targetId="aacb-8a81-62c0-3db8" primary="false">
          <modifiers>
            ...
            <modifier type="decrement" value="1" field="af9a-899a-8bbb-130a">
              <conditions>
                <condition type="equalTo" value="1" field="selections" scope="force" childId="4824-0d60-2e58-8bca" shared="true" includeChildSelections="true"/>
              </conditions>
            </modifier>
    ...
    <forceEntry name="6-Combat Patrol" id="52d8-9148-50b7-99df" hidden="false">
      <categoryLinks>
        <categoryLink name="Elites" hidden="false" id="50c6-db82-cdf4-f622" targetId="6d25-b346-c314-6911" primary="false"/>
        <categoryLink name="HQ" hidden="false" id="2982-3e6c-42b0-2727" targetId="a8a7-7a4b-5f7e-2138" primary="false">
          <comment>Note that Space Wolves get a special HQ selection process. They must have 1 HQ per 750 points.</comment>
          <modifiers>
            <modifier type="increment" value="1" field="c12d-1076-9bba-aaca">
              <repeats>
                <repeat value="750" repeats="1" field="4ed5-2f92-9abc-2870" scope="force" childId="9bbd-df2b-520d-778d" shared="true" roundUp="false" percentValue="false" includeChildSelections="false" includeChildForces="false"/>
              </repeats>
            </modifier>
          </modifiers>
          <constraints>
            <constraint type="min" value="1" field="selections" scope="parent" shared="true" id="c12d-1076-9bba-aaca" percentValue="false" includeChildSelections="false" includeChildForces="false"/>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="867a-862d-3a2d-3654" percentValue="false" includeChildSelections="false" includeChildForces="false"/>
          </constraints>
        </categoryLink>
        <categoryLink name="Troops" hidden="false" id="8918-8f03-a87a-f0f4" targetId="0ef5-5056-d52e-3cfd" primary="false">
          <modifiers>
            <modifier type="set" value="0" field="3264-698d-8fc3-5c3f">
              <conditions>
                <condition type="instanceOf" value="0" field="selections" scope="primary-catalogue" childId="7f78-c07f-9062-0d43" shared="true" percentValue="false" includeChildSelections="false" includeChildForces="false"/>
              </conditions>
            </modifier>
          </modifiers>
          <constraints>
            <constraint type="min" value="1" field="selections" scope="parent" shared="true" id="3264-698d-8fc3-5c3f" percentValue="false" includeChildSelections="false" includeChildForces="false"/>
          </constraints>
        </categoryLink>
        <categoryLink name="Fast Attack" hidden="false" id="d3ed-c52f-b703-0909" targetId="34e2-d53c-28ab-44cf" primary="false"/>
        <categoryLink name="Heavy Support" hidden="false" id="4912-8b84-7de8-185b" targetId="aacb-8a81-62c0-3db8" primary="false"/>
        <categoryLink name="No Force Org" hidden="false" id="b4bc-847d-4958-cab6" targetId="be45-5314-4388-5bfd" primary="false"/>
      </categoryLinks>
      <constraints>
        <constraint type="max" value="400" field="4ed5-2f92-9abc-2870" scope="force" shared="true" id="d98d-4bf9-91e1-20af" includeChildSelections="true"/>
      </constraints>
    </forceEntry>
  </forceEntries>
  <entryLinks>
                        ...
                        <selectionEntryGroup id="979f-0ca7-23ee-873b" name="Single-Handed Weapons" hidden="false" collective="false" import="true">
                          ...
                          <selectionEntries>
                            ...
                            <selectionEntry id="eae5-61c6-d744-7f76" name="Close Combat Weapon" hidden="false" collective="false" import="true" type="upgrade">
                              ...
                              <infoLinks>
                                <infoLink id="a780-c28f-31b4-37ed" name="Close Combat Weapon (CCW)" hidden="false" targetId="46d5-85f2-d932-f0a2" type="profile"/>
                              </infoLinks>
                              <costs>
                                <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="1"/>
                              </costs>
                            ...
                            <selectionEntry id="25c6-7af0-22e0-d644" name="Power Fist" hidden="false" collective="false" import="true" type="upgrade">
                              ...
                              <infoLinks>
                                <infoLink id="2efc-4afa-3df6-2332" name="Power Fist/Claw" hidden="false" targetId="a161-ed4b-bcb7-0a01" type="profile"/>
                              </infoLinks>
                              <costs>
                                <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="25"/>
                              </costs>
                    ...
                    <selectionEntryGroup id="8c1d-7067-07c6-0783" name="Veteran Weapons" hidden="false" collective="false" import="true">
                      ...
                      <selectionEntries>
                        <selectionEntry id="6cc4-fd78-c6e5-b462" name="Power Fist" hidden="false" collective="false" import="true" type="upgrade">
                          <infoLinks>
                            <infoLink id="3ff0-b67e-dd22-74fa" name="Power Fist/Claw" hidden="false" targetId="a161-ed4b-bcb7-0a01" type="profile"/>
                          </infoLinks>
                          <costs>
                            <cost name="pts" typeId="4ed5-2f92-9abc-2870" value="25"/>
                          </costs>
  ...
  <sharedRules>
    ...
    <rule id="b4ea-750c-d9a4-e398" name="Infiltrate" hidden="false">
      <description>This Unit may use the Infiltrate rule on any Mission that allows
this rule. Otherwise must deploy as normal. 


If both sides have models with this rule, flip a coin to see who deploys first then
alternate deploying Units with this rule. 


Deploy Infiltrators after all other models have been deployed, anywhere on the table more than 12” from any enemy Unit. 


Enemy Units must not be able to draw LOS on Infiltrators, unless they are at least 18” away.</description>
    </rule>
...
-Cannot fire any weapons when moved more than 12&quot;</description>
    ...
    <rule id="ebe5-6318-0fba-b84c" name="Twin-Linked" hidden="false">
      <description>Any missed shots fired from this weapon may be re-rolled once.</description>
    </rule>
    <rule id="e65f-0536-e057-e2d2" name="Combi Weapons" hidden="false">
      <description>Bolter combined with another weapon, may fire either kind on Shooting Phase but not both. 


The Bolter may be fired any number of times, the additional weapon may only be fired once per-game.</description>
    </rule>
...
-Move up to 6&quot; as normal Infantry</description>
    ...
    <rule id="b137-13a1-eb97-c5e5" name="Fearless" hidden="false">
      <description>Automatically pass Morale Tests, never have to Fall Back, and can never be pinned. If a Fearless Character joins a unit without this rule he loses this rule’s effects.</description>
    </rule>
    <rule id="3a88-67df-4004-176b" name="Move Through Cover" hidden="false">
      <description>When moving through Difficult Terrain roll 3D6 and take the highest result for inches moved.</description>
    </rule>
    ...
    <rule id="445e-e873-2a3f-776f" name="Monstrous Creature" hidden="false">
      <description>May re-roll Difficult Terrain Tests.
...
not Invulnerable Saves). When attacking a Vehicle in Close Combat roll 2D6+Strength for Armor Penetration unless specified otherwise.</description>
    ...
    <rule id="3f9b-513f-8f10-5cc6" name="And They Shall Know No Fear" hidden="false">
      <description>The unit automatically passes Morale Tests to regroup and may make such tests even if below half of Starting Strength. If caught by a Sweeping Advance, the Unit is not destroyed and fights normally. 


May Move normally after regrouping, as Units with this rule don&apos;t automatically count as having moved if they regroup.</description>
    </rule>
    ...
    <rule id="d2c6-0bb0-d830-4c62" name="Storm Shield" hidden="false">
      <description>Gives a 4+ invulnerable save in close combat. 


Cannot be combined with Rosarius or Iron Halo saves and the bearer may never claim the +1 Attack bonus for being armed with two CCWs</description>
    </rule>
...
-Can shoot more than one target if desired, picking a target for each weapon.</description>
    ...
    <rule id="a61d-d857-0035-c7a8" name="Tank Hunter" publicationId="8acd-6511-d7f4-63c7" page="163" hidden="false">
      <comment>Infantry Battle Honors; Vehicle Battle Honor</comment>
      <description>+1 to all Armor Penetration rolls, automatically pass Morale Tests caused by Tank Shock.</description>
    </rule>
    <rule id="f6a6-34fa-127b-d52d" name="Counter-Attack" publicationId="8acd-6511-d7f4-63c7" page="163" hidden="false">
      <comment>Infantry Battle Honor; Bike/Cav Battle Honor</comment>
      <description>If Charged, the Unit with this rule must have all non-Engaged models Charge themselves as if it were their own Assault Phase, but only towards the attacking Unit’s models. 


However, does not get +1 attacks for Charging and may not use this rule if the Unit was charged as the result of a Consolidation move.</description>
    </rule>
    <rule id="2c8e-9381-711b-6fe3" name="Skilled Rider" publicationId="8acd-6511-d7f4-63c7" page="163" hidden="false">
      <comment>Bike/Cav Battle Honor</comment>
      <description>Models with this rule may re-roll all Dangerous Terrain Tests.</description>
    </rule>
...
Blind/smoke grenades are used in the Shooting phase instead of the unit firing any weapons. Mark the unit as using its blind/smoke grenades by placing cotton wool around them. A unit cannot assault on the same turn it uses blind/smoke grenades. The blind/smoke screen lasts until the start of the player&apos;s next turn and until then the unit counts as in cover with a 5+ cover save. Because they count as being in cover, models in the unit will also strike first if assaulting, unless the enemy is armed with something like frag grenades, or has an ability that allows them to always strike first.</description>
    ...
    <rule name="Artillery" id="bb1b-3384-68c9-f5ea" hidden="false">
      <description>Includes large weapons and their crews, weapons large enough to be removed separately in addition to crew casualties. 




A typical Unit of Artillery is 1 model, plus crew.</description>
    </rule>
    <rule name="Assault" id="82cc-d450-2fe6-32aa" hidden="false">
      <description>This weapon fires (X) times, whether the model moves or not, and regardless of range. 


Units with this weapon can fire the weapon during the Shooting Phase and still Charge during the Assault Phase.</description>
    </rule>
    <rule name="Barrage" id="9b4c-4c26-021f-48ff" hidden="false">
      <description>When firing this weapon the model does not have to check LOS, nor must they test Leadership (Ld) to fire at any other target. 




Barrage weapons may not intentionally target Models where the Blast template would partially cover models from their own army. 




Also counts as Pinning</description>
    </rule>
    <rule name="Blast" id="1c88-362b-a4b1-03ca" hidden="false">
      <description>Upon a successful hit with this weapon, place a Blast Marker (3” diameter) with the center mark on the target. 


For all other models with bases partially covered by the Blast Marker roll 1D6. 


For all results of 4+ those models are also hit. 


Some non-Ordnance weapons use the Large Blast Marker (5” diameter).</description>
    </rule>
    <rule name="Gets Hot!" id="ec38-606e-e9f5-4563" hidden="false">
      <description>When a model equipped with this weapon rolls a 1 To-Hit, roll a Saving Throw for that model. 




If failed, that model immediately takes a Wound. 




The chance of Gets Hot! is equal to the number of shots fired (e.g. 2 shots, Gets Hot (1-2). 




Any successful hits still hit the target even if the weapon Gets Hot.</description>
    </rule>
    <rule name="Heavy" id="7f8e-f30c-745f-fdb9" hidden="false">
      <description>Models with this weapon can either move, or shoot, but not both.


When shooting the weapon fires (X) times. 


Units with this weapon cannot make a Charge during the Assault Phase if the weapon fired during the Shooting Phase. 


Vehicles and Monstrous Creatures ignore this restrictions on movement</description>
    </rule>
    <rule name="Lance" id="6e3c-2344-f310-10b5" hidden="false">
      <description>Against attacks from this weapon Vehicle Armor is never counted higher than 12, regardless of the actual Vehicle Armor for that facing.</description>
    </rule>
    <rule name="Melta" id="59e2-ae31-ebc7-5d2f" hidden="false">
      <description>When firing this weapon at a target half its Range or less away, roll an additional D6 and sum the result when checking Vehicle Armor Penetration.</description>
    </rule>
    <rule name="Ordnance" id="e01d-80f2-ff4e-2f70" hidden="false">
...
When Ordnance is fired by a moving Vehicle , roll 2D6 and keep the highest result instead.</description>
    ...
    <rule name="Pinning" id="943e-e70e-9219-0f67" hidden="false">
      <description>If the target of an attack by a Pinning weapon takes at least 1 casualty the target Unit must take a Leadership (Ld) test. 




If failed, the Unit may not take any action until the following Turn.




If caused by Ordinance Barrage, -1 Leadership (Ld).




Already Pinned Units don’t need to take a Morale test when taking 25% casualties or more. 




Assaulting a Pinned Unit removes its Pinned status.</description>
    </rule>
    <rule name="Pistol" id="8e25-63d7-b84f-1d72" hidden="false">
      <description>This weapon can shoot once at targets up to 12” away, or else twice up to maximum range if the model equipped with this weapon has not moved during the current Turn. 


Units that fired this weapon once can make a Charge during the Assault
phase, but cannot if it fired twice.</description>
    </rule>
    <rule name="Poisoned" id="1dad-25fb-3fd3-e471" hidden="false">
...
This weapon cannot be fired during the Shooting Phase if the model’s Unit is to Charge during the Assault Phase.</description>
    </rule>
    <rule name="Template" id="166e-71a4-3e35-c13f" hidden="false">
      <description>Replaces Range with an 8” long teardrop-shaped template which measures from the edge of the shooting model’s base. 


All models fully or partially within the Template are automatically Hit, independently of any cover. 


The facing of Vehicles struck uses the direction the
shooter is firing from. 


If a unit fires multiple Template weapons, resolve each one at a time. 


Twin-linked Template Weapons may re-roll To-Wound and/or Armor Penetration since they automatically hit.</description>
    </rule>
    <rule name="Feel No Pain" id="3215-d909-8d88-0880" hidden="false">
      <description>For any Wound that would cause a Casualty, roll D6. 


On 4+ the Wound is ignored and the model does not become a
Casualty. 


May not be used if caused by a weapon that would inflict Instant Death, nor against weapons that do not allow Armor Saves.</description>
    </rule>
    <rule name="Fleet" id="5bc1-1def-4f65-1298" hidden="false">
      <description>In any turn where this Unit does not shoot, nor use a psychic power that replaces shooting, they may move an additional D6” during the Shooting Phase, ignoring the effects of Difficult Terrain.</description>
    </rule>
    <rule name="Furious Charge/Assault" id="6176-5719-d7a9-12ed" hidden="false">
      <description>+1 to Initiative and Strength for this Unit when Charging. 


Does not affect Sweeping Advances.</description>
    </rule>
    <rule name="Hit &amp; Run" id="9257-ef6a-6443-44af" hidden="false">
      <description>May choose to leave close combat, declared at the end of the Close Combat phase. 


Immediately moves in a straight line 3D6” away from the Unit they are Locked with, ignoring those models for the purposes of movement. 


May not be used to Engage with a different Unit. 


The Break-off move is automatically successful and not subject to sweeping
advance. 


The enemy may consolidate normally however.</description>
    </rule>
    <rule name="Night Vision/Acute Senses" id="2746-9a9e-051e-5143" hidden="false">
      <description>When Night Fighting mission rules are in use, this model may re-roll all spotting Tests. 


Characters joining a Unit with this rule confer the effects onto the Unit.</description>
    </rule>
    <rule name="Preferred Enemy" id="3ace-66a4-5990-ad24" hidden="false">
      <description>Against (X) always hit on 3+ during Close Combat. 


This rule doesn&apos;t apply to Independent Characters, Monstrous Creatures or vehicles without a WS.</description>
    </rule>
    <rule name="Scouts" id="5570-337d-548e-b05e" hidden="false">
      <description>Models with this rule must always be deployed first regardless of any scenario special rule. 


Before rolling to see who goes first but after deployment has finished, all models with this rule may take a free move according to normal Movement rules.</description>
    </rule>
    <rule name="Slow &amp; Purposeful" id="16a8-2dbb-055e-7066" hidden="false">
      <description>Models with this rule always move as if moving through Difficult Terrain, are always treated as if stationary when shooting, and never receive +1A when Charging.</description>
    </rule>
    <rule name="Small/Stealth" id="e5d8-e039-3469-4829" hidden="false">
      <description>All rolls for Cover Saves are improved by +1.</description>
    </rule>
    <rule name="Stubborn" id="103f-dbc4-c6da-7f17" hidden="false">
      <description>Automatically pass Morale Tests, never have to Fall Back, but can still be Pinned.


An Independent Character with this rule confers the effect to any Unit they join.</description>
    </rule>
    <rule name="True Grit" id="ea58-a881-49ac-587d" hidden="false">
      <description>Models with this rule may treat their Bolter as a Bolt Pistol in Close Combat, but they don&apos;t gain the +1 Attack bonus when charging. 


This rule doesn&apos;t apply to Combi-Weapons. 


Grey Knights Space Marines may apply it to Storm Bolters.</description>
    </rule>
    <rule name="Turbo Boosters" id="3ca7-a7e1-bde0-4622" hidden="false">
      <description>Models with this rule may move up to 24” during the Movement
Phase, however may not move through Difficult Terrain, shoot, nor launch assaults. 


When shooting against this model during the same Battle Round, treat the model&apos;s Armor save as being an Invulnerable Save. 


The model must move at least 18” to gain this benefit.</description>
    </rule>
    <rule name="Vulnerable to Blast/Templates" id="2ced-aff0-e5f3-abd4" hidden="false">
      <description>A Vehicle model counts hits from Blast or Template weapons as two hits. 


A Non-vehicle models counts each failed Saving Throw as two Wounds.</description>
    </rule>
    <rule name="Swarms" id="b921-dbdf-9cf1-194e" hidden="false">
      <description>All rolls for Cover Saves are improved by +1.


A Vehicle model counts hits from Blast or Template weapons as two hits. 


A Non-vehicle models counts each failed Saving Throw as two Wounds.</description>
    </rule>
    <rule name="Psychic Power" id="28e0-9363-7fbb-0f70" hidden="false">
      <description>User must take a Psychic Test before use by rolling against it&apos;s Ld on 2D6


If failed, the user cannot use the power that turn


If passed, the power may be used</description>
    </rule>
    <rule name="Perils of the Warp" id="dcee-7533-2120-4e58" hidden="false">
      <description>If the Psyker rolls a 2 or 12 when testing Ld, it suffers one automatic Strength 6 wound with no saves of any kind allowed.


On a roll of 2, the power still works.</description>
    </rule>
    <rule name="Rending" id="2364-f229-68aa-198d" hidden="false">
      <description>All rolls To-Hit of 6 with this weapon results in an automatic Wound that ignores Armor Save (Sv) (but not Invulnerable Save). 
  ...
  <sharedProfiles>
    ...
    <profile id="7077-4e34-5c92-5320" name="Multi-melta" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="S" typeId="24d8-2110-08fa-d844">8</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">1</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Heavy 1 Melta</characteristic>
    ...
    <profile id="112a-baea-9eeb-b1b5" name="Plasma Gun" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Rapid Fire, Gets Hot!</characteristic>
    ...
    <profile id="7b91-b670-d042-7c88" name="Plasma Pistol" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="S" typeId="24d8-2110-08fa-d844">7</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Pistol 1 Gets Hot!</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">If a Plasma Pistol is used as a CCW it confers no bonus to Strength (S) nor Armor Penetration (AP) advantages.</characteristic>
      </characteristics>
    </profile>
    ...
    <profile id="c7a3-7006-5226-8181" name="Lightning Claw" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Ignores the target Armor Save (Sv) (but not Invulnerable Save), and may re-roll any failed To-Wound rolls once. 


For a single model equipped with two, +1 Attack.</characteristic>
      </characteristics>
    </profile>
    ...
    <profile id="46d5-85f2-d932-f0a2" name="Close Combat Weapon (CCW)" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">Melee</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">As User</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">-</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Weapons of this type confer no bonus to Strength (S) but do grant +1 Attack (A) during the Assault Phase.</characteristic>
      </characteristics>
    </profile>
...
Counts as a [ower fist but strikes at the Dreadnought’s normal Initiative. &amp; If armed with two close combat weapons, the Dreadnought gains +1 Attack</characteristic>
    ...
    <profile id="ff9c-5b94-680f-36d5" name="Power Claw" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">Melee</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">2x</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
    ...
    <profile id="3f9c-e7c1-c442-3b7c" name="Assault Cannon" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="S" typeId="24d8-2110-08fa-d844">6</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">4</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Heavy 3 Rending</characteristic>
    ...
    <profile id="9a19-ea1c-3d75-94aa" name="Plasma Cannon" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="S" typeId="24d8-2110-08fa-d844">7</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Heavy 1 Blast, Gets Hot!</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">If you roll a 1 to hit with a plasma weapon it has overheated and injured the model firing it. Make an armor save for the model, otherwise it will suffer a wound. Plasma weapons on vehicles are not affected by overheating.</characteristic>
      </characteristics>
    </profile>
...
When specified, grants a bonus to S or Wounds on a fixed value regardless of target Toughness (T).</characteristic>
    ...
    <profile id="9edb-0754-ffa8-9dd3" name="Thunder Hammer" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">This weapon counts as a Power Fist, but also causes any
target Wounded but not killed to attack at Initiative (I) 1 during the next Assault Phase. 


Vehicles struck always suffer the “Crew Shaken” effect in addition to any other results.</characteristic>
      </characteristics>
    </profile>
    <profile id="a161-ed4b-bcb7-0a01" name="Power Fist/Claw" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">Melee</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">2x</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">2</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Doubles user’s S up to a maximum of S10, and Hits ignore Armor Save (Sv) (but not Invulnerable Save). 


Models attacking with this weapon are always delivered at Initiative (I) 1 and ignore any bonuses for special rules/cover/etc.</characteristic>
      </characteristics>
    </profile>
    <profile id="e5ab-52f0-b14b-e93c" name="Force Weapon" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        ...
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">1</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Rolls To-Hit and To-Wound as normal, allowing any Invulnerable Save. 


For any Wound that wasn’t Saved (Sv), the model equipped with the Force Weapon makes a Psychic Test. 


On success the target suffers Instant Death regardless of remaining Wounds. 


Has no effect against targets without Wounds such as Vehicles.</characteristic>
      </characteristics>
    </profile>
...
Models attacking with this weapon are always delivered at Initiative (I) 1 and ignore any bonuses for special rules/cover/etc.


Roll 2D6 for armor penetration.</characteristic>
      </characteristics>
    </profile>
    ...
    <profile id="f55b-a34b-6ace-cfde" name="Heavy Close Combat Weapon" hidden="false" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">Melee</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">As User</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">-</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Weapons of this type confer no bonus to Strength (S) but do grant +1 Attack (A) during the Assault Phase.


The maximum Save (Sv) of any target against this weapon is
4+, even if it would normally be better.</characteristic>
      </characteristics>
    </profile>
    <profile name="Witchblade" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon" hidden="false" id="b681-3e0b-9620-1f78">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">Melee</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">User</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">-</characteristic>
        <characteristic name="Type" typeId="d3f6-19e8-ac9e-ae13">Melee</characteristic>
        <characteristic name="Abilities" typeId="492d-1f80-b777-26f2">Attacks with this weapon always make their To-Wound roll against a fixed value of 2+. 


Armor Saves (Sv) are made as normal. 


Against Vehicles only, additionally multiplies Strength (S) by 3, up to a maximum of Strength (S) 10.</characteristic>
      </characteristics>
    </profile>
    <profile name="Heavy Bolter - Hellfire Round" typeId="b399-8a1b-bf0b-c5b7" typeName="Weapon" hidden="false" id="d36c-8ff7-d597-a81e">
      <characteristics>
        <characteristic name="Range" typeId="deb8-131d-bdcf-1376">36&quot;</characteristic>
        <characteristic name="S" typeId="24d8-2110-08fa-d844">5</characteristic>
        <characteristic name="AP" typeId="25ce-028f-0aae-2855">4</characteristic>
  ...
  <sharedInfoGroups>
    <infoGroup name="Infantry Characteristics" id="e8af-9a90-983b-7175" hidden="false">
      <rules>
        <rule name="Weapon Skill (WS)" id="c25f-c6cf-9a89-ce5f" hidden="false">
          <description>Ability in melee fighting. The higher the better. A normal Human has WS3.</description>
        </rule>
        <rule name="Ballistic Skill (BS)" id="d456-89e0-0c1f-ab07" hidden="false">
          <description>Accuracy with ranged attacks. The higher the better. A normal
Human has BS3.</description>
        </rule>
        <rule name="Strength (S)" id="3fdb-ec32-7b67-6d0a" hidden="false">
          <description>How hard an attack from this model hits. The higher the better. A normal Human has S3.</description>
        </rule>
        <rule name="Toughness (T)" id="1288-74b9-d34a-e959" hidden="false">
          <description>How well this model resists an attack. The higher the better. A normal Human has T3.</description>
        </rule>
        <rule name="Wounds (W)" id="fbb9-24a3-54cc-9bfd" hidden="false">
          <description>How much damage a model can take before it can no longer fight. The higher the better. A normal Human has W1.</description>
        </rule>
        <rule name="Initiative (I)" id="034c-8252-27ed-acaa" hidden="false">
          <description>Used in melee to determine which models strike first. The higher the better. A normal Human has I3.</description>
        </rule>
        <rule name="Attacks (A)" id="212e-e188-f312-ef64" hidden="false">
          <description>Number of Attacks a model makes during a melee. The higher the better. A normal Human has A1.</description>
        </rule>
        <rule name="Leadership (Ld)" id="d69c-0be0-59a7-5d03" hidden="false">
          <description>Measures courage and self-control. The higher the better.

Tested by rolling 2D6, succeeding if the result is less than the Characteristic of the model. A Normal Human has Ld7.</description>
        </rule>
        <rule name="Save (Sv)" id="d9fe-7d78-4d14-b06c" hidden="false">
          <description>Used to avoid damage. The lower the better. 


Tested by rolling 1D6, succeeding if the result is equal or greater to the Characteristic. A Normal Human has Sv 5+.


Some Units might have a second value, noted X+/X++, indicating an Invulnerable Save that is harder to bypass.</description>
        </rule>
      </rules>
    </infoGroup>
  </sharedInfoGroups>
  <readme>Based on KSnyder1986&apos;s 3rd Edition data</readme>
</gameSystem>
